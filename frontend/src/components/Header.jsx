      ...
      <div className="mx-auto max-w-7xl px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="#" className="text-sm font-medium text-slate-300 hover:text-slate-100">
              Sign in
            </a>
            <a href="#" className="inline-flex items-center gap-2 rounded-md bg-slate-100 text-slate-900 text-sm font-semibold px-3.5 py-2 hover:bg-white transition-colors">
